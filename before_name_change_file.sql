...
CREATE TABLE `admin` (
  ...
  CONSTRAINT `admin_ibfk_1` FOREIGN KEY (`adminname`) REFERENCES `student` (`username`)
...
INSERT INTO `admin` VALUES ('admin'),('fx1'),('ggabeau'),('lteffera'),('sclark4'),('scott');
...
-- Dump completed on 2021-04-02 11:35:10
